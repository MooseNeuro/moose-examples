...
class ClampCircuit(object):
    ...
    def __init__(self, path, squid):
        ...
        moose.connect(self.iclamp, 'output', squid.compartment, 'injectMsg')
        ...
        moose.connect(squid.compartment, 'VmOut', self.pid, 'sensedIn')
        moose.connect(self.pid, 'output', squid.compartment, 'injectMsg')
        current_table = moose.Table('/data/Im')
        moose.connect(current_table, 'requestOut', squid.compartment, 'getIm')
